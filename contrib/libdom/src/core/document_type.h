...
dom_exception
_dom_document_type_get_notations(dom_document_type *doc_type,
				 struct dom_namednodemap **result);
...
#define DOM_DOCUMENT_TYPE_VTABLE                                               \
	_dom_document_type_get_name, _dom_document_type_get_entities,          \
...
#define DOM_NODE_VTABLE_DOCUMENT_TYPE                                          \
	_dom_node_try_destroy, _dom_node_get_node_name,                        \
		...
		_dom_document_type_set_text_content, _dom_node_is_same,        \

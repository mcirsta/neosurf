...
dom_exception _dom_attr_create(struct dom_document *doc, dom_string *name, dom_string *namespace, dom_string *prefix,
    bool specified, struct dom_attr **result);
void _dom_attr_destroy(struct dom_attr *attr);
dom_exception _dom_attr_initialise(struct dom_attr *a, struct dom_document *doc, dom_string *name,
    dom_string *namespace, dom_string *prefix, bool specified, struct dom_attr **result);
...
#define DOM_ATTR_VTABLE                                                                                                \
    _dom_attr_get_name, _dom_attr_get_specified, _dom_attr_get_value, _dom_attr_set_value, _dom_attr_get_owner,        \
        _dom_attr_get_schema_type_info, _dom_attr_is_id
...
#define DOM_NODE_VTABLE_ATTR                                                                                           \
    _dom_node_try_destroy, _dom_node_get_node_name, _dom_attr_get_node_value, /*overload*/                             \
        _dom_node_set_node_value, _dom_node_get_node_type, _dom_node_get_parent_node, _dom_node_get_child_nodes,       \
        _dom_node_get_first_child, _dom_node_get_last_child, _dom_node_get_previous_sibling,                           \
        _dom_node_get_next_sibling, _dom_node_get_attributes, _dom_node_get_owner_document, _dom_node_insert_before,   \
        _dom_node_replace_child, _dom_node_remove_child, _dom_node_append_child, _dom_node_has_child_nodes,            \
        ...
        _dom_node_get_local_name, _dom_node_has_attributes, _dom_node_get_base, _dom_node_compare_document_position,   \
        _dom_node_get_text_content, _dom_node_set_text_content, _dom_node_is_same,                                     \
...
#define DOM_ATTR_PROTECT_VTABLE __dom_attr_destroy, _dom_attr_copy

...
#define DOM_ATTR_VTABLE                                                        \
	_dom_attr_get_name, _dom_attr_get_specified, _dom_attr_get_value,      \
		_dom_attr_set_value, _dom_attr_get_owner,                      \
...
#define DOM_NODE_VTABLE_ATTR                                                   \
	_dom_node_try_destroy, _dom_node_get_node_name,                        \
		...
		_dom_node_set_node_value, _dom_node_get_node_type,             \
		_dom_node_get_parent_node, _dom_node_get_child_nodes,          \
		_dom_node_get_first_child, _dom_node_get_last_child,           \
		_dom_node_get_previous_sibling, _dom_node_get_next_sibling,    \
		_dom_node_get_attributes, _dom_node_get_owner_document,        \
		_dom_node_insert_before, _dom_node_replace_child,              \
		_dom_node_remove_child, _dom_node_append_child,                \
		_dom_node_has_child_nodes, _dom_attr_clone_node, /*overload*/  \
		_dom_node_normalize, _dom_node_is_supported,                   \
		_dom_node_get_namespace, _dom_node_get_prefix,                 \
		...
		_dom_node_is_same, _dom_attr_lookup_prefix, /*overload*/       \

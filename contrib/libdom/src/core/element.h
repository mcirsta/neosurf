...
#define DOM_ELEMENT_VTABLE                                                     \
	_dom_element_get_tag_name, _dom_element_get_attribute,                 \
		_dom_element_set_attribute, _dom_element_remove_attribute,     \
		...
		_dom_element_get_attribute_ns, _dom_element_set_attribute_ns,  \
		...
		_dom_element_has_attribute, _dom_element_has_attribute_ns,     \
		_dom_element_get_schema_type_info,                             \
		_dom_element_set_id_attribute,                                 \
		_dom_element_set_id_attribute_ns,                              \
		_dom_element_set_id_attribute_node, _dom_element_get_classes,  \
...
dom_exception
_dom_element_has_attributes(dom_node_internal *node, bool *result);
...
#define DOM_NODE_VTABLE_ELEMENT                                                \
	_dom_node_try_destroy, _dom_node_get_node_name,                        \
		...
		_dom_node_is_same, _dom_element_lookup_prefix, /*overload*/    \
...
#define dom_element_parse_attribute(e, n, v, p)                                \
	dom_element_parse_attribute((dom_element *)(e),                        \
				    (dom_string *)(n),                         \
				    (dom_string *)(v),                         \
				    (dom_string **)(p))
...
#define dom_element_copy_internal(o, n)                                        \
	_dom_element_copy_internal((dom_element *)(o), (dom_element *)(n))

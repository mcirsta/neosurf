...
#define DOM_ELEMENT_VTABLE                                                                                             \
    _dom_element_get_tag_name, _dom_element_get_attribute, _dom_element_set_attribute, _dom_element_remove_attribute,  \
        _dom_element_get_attribute_node, _dom_element_set_attribute_node, _dom_element_remove_attribute_node,          \
        _dom_element_get_elements_by_tag_name, _dom_element_get_attribute_ns, _dom_element_set_attribute_ns,           \
        _dom_element_remove_attribute_ns, _dom_element_get_attribute_node_ns, _dom_element_set_attribute_node_ns,      \
        _dom_element_get_elements_by_tag_name_ns, _dom_element_has_attribute, _dom_element_has_attribute_ns,           \
        _dom_element_get_schema_type_info, _dom_element_set_id_attribute, _dom_element_set_id_attribute_ns,            \
        _dom_element_set_id_attribute_node, _dom_element_get_classes, _dom_element_has_class
...
#define DOM_NODE_VTABLE_ELEMENT                                                                                        \
    _dom_node_try_destroy, _dom_node_get_node_name, _dom_node_get_node_value, _dom_node_set_node_value,                \
        _dom_node_get_node_type, _dom_node_get_parent_node, _dom_node_get_child_nodes, _dom_node_get_first_child,      \
        _dom_node_get_last_child, _dom_node_get_previous_sibling, _dom_node_get_next_sibling,                          \
        _dom_element_get_attributes, /*overload*/                                                                      \
        _dom_node_get_owner_document, _dom_node_insert_before, _dom_node_replace_child, _dom_node_remove_child,        \
        _dom_node_append_child, _dom_node_has_child_nodes, _dom_node_clone_node, _dom_node_normalize,                  \
        _dom_node_is_supported, _dom_node_get_namespace, _dom_node_get_prefix, _dom_node_set_prefix,                   \
        _dom_node_get_local_name, _dom_element_has_attributes, /*overload*/                                            \
        _dom_node_get_base, _dom_node_compare_document_position, _dom_node_get_text_content,                           \
        _dom_node_set_text_content, _dom_node_is_same, _dom_element_lookup_prefix, /*overload*/                        \
        _dom_element_is_default_namespace, /*overload*/                                                                \
        _dom_element_lookup_namespace, /*overload*/                                                                    \
        _dom_node_is_equal, _dom_node_get_feature, _dom_node_set_user_data, _dom_node_get_user_data
...
struct dom_element_protected_vtable {
    ...
    dom_exception (*dom_element_parse_attribute)(
        dom_element *ele, dom_string *name, dom_string *value, dom_string **parsed);
...
dom_element_parse_attribute(dom_element *ele, dom_string *name, dom_string *value, dom_string **parsed)
{
    struct dom_node_internal *node = (struct dom_node_internal *)ele;
    return ((dom_element_protected_vtable *)node->vtable)->dom_element_parse_attribute(ele, name, value, parsed);
}
#define dom_element_parse_attribute(e, n, v, p)                                                                        \
    dom_element_parse_attribute((dom_element *)(e), (dom_string *)(n), (dom_string *)(v), (dom_string **)(p))
...
#define DOM_NODE_PROTECT_VTABLE_ELEMENT __dom_element_destroy, _dom_element_copy

/* Helper functions*/
dom_exception _dom_element_copy_internal(dom_element *old, dom_element *new);
#define dom_element_copy_internal(o, n) _dom_element_copy_internal((dom_element *)(o), (dom_element *)(n))

...
enum dom_whitespace_op {
    ...
    DOM_WHITESPACE_STRIP = DOM_WHITESPACE_STRIP_LEADING | DOM_WHITESPACE_STRIP_TRAILING,
    DOM_WHITESPACE_COLLAPSE = (1 << 2),
    DOM_WHITESPACE_STRIP_COLLAPSE = DOM_WHITESPACE_STRIP | DOM_WHITESPACE_COLLAPSE
};

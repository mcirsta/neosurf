...
dom_exception
_dom_text_initialise(dom_text *text, struct dom_document *doc, dom_node_type type, dom_string *name, dom_string *value);
...
#define DOM_TEXT_VTABLE                                                                                                \
    _dom_text_split_text, _dom_text_get_is_element_content_whitespace, _dom_text_get_whole_text,                       \
...
#define DOM_TEXT_PROTECT_VTABLE __dom_text_destroy, _dom_text_copy

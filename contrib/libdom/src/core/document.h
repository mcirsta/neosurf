...
struct dom_document {
	...
	dom_string *
		_memo_domcharacterdatamodified; /**< DOMCharacterDataModified */
...
#define DOM_DOCUMENT_VTABLE                                                    \
	_dom_document_get_doctype, _dom_document_get_implementation,           \
		...
		_dom_document_import_node, _dom_document_create_element_ns,    \
...
#define DOM_DOCUMENT_PROTECT_VTABLE _dom_document_destroy, _dom_document_copy

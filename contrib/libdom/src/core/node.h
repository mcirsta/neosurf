...
dom_exception
_dom_node_get_prefix(dom_node_internal *node, dom_string **result);
...
#define DOM_NODE_EVENT_TARGET_VTABLE                                           \
	_dom_node_add_event_listener, _dom_node_remove_event_listener,         \
		_dom_node_dispatch_event, _dom_node_add_event_listener_ns,     \
		_dom_node_remove_event_listener_ns

#define DOM_NODE_VTABLE                                                        \
	_dom_node_try_destroy, _dom_node_get_node_name,                        \
		_dom_node_get_node_value, _dom_node_set_node_value,            \
		_dom_node_get_node_type, _dom_node_get_parent_node,            \
		_dom_node_get_child_nodes, _dom_node_get_first_child,          \
		_dom_node_get_last_child, _dom_node_get_previous_sibling,      \
		_dom_node_get_next_sibling, _dom_node_get_attributes,          \
		_dom_node_get_owner_document, _dom_node_insert_before,         \
		_dom_node_replace_child, _dom_node_remove_child,               \
		_dom_node_append_child, _dom_node_has_child_nodes,             \
		_dom_node_clone_node, _dom_node_normalize,                     \
		_dom_node_is_supported, _dom_node_get_namespace,               \
		_dom_node_get_prefix, _dom_node_set_prefix,                    \
		_dom_node_get_local_name, _dom_node_has_attributes,            \
		_dom_node_get_base, _dom_node_compare_document_position,       \
		_dom_node_get_text_content, _dom_node_set_text_content,        \
		_dom_node_is_same, _dom_node_lookup_prefix,                    \
		_dom_node_is_default_namespace, _dom_node_lookup_namespace,    \
		_dom_node_is_equal, _dom_node_get_feature,                     \
		_dom_node_set_user_data, _dom_node_get_user_data


/* Following comes the protected vtable */
void _dom_node_destroy(struct dom_node_internal *node);
dom_exception
_dom_node_copy(struct dom_node_internal *old, struct dom_node_internal **copy);

#define DOM_NODE_PROTECT_VTABLE _dom_node_destroy, _dom_node_copy
...
dom_node_copy(struct dom_node_internal *old, struct dom_node_internal **copy)
{
	return ((dom_node_protect_vtable *)old->vtable)->copy(old, copy);
}
#define dom_node_copy(o, c)                                                    \
	dom_node_copy((dom_node_internal *)(o), (dom_node_internal **)(c))
...
#define dom_node_mark_pending(n)                                               \
	_dom_node_mark_pending((dom_node_internal *)(n))
...
#define dom_node_remove_pending(n)                                             \
	_dom_node_remove_pending((dom_node_internal *)(n))

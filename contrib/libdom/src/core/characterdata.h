...
#define DOM_CHARACTERDATA_VTABLE                                                                                       \
    _dom_characterdata_get_data, _dom_characterdata_set_data, _dom_characterdata_get_length,                           \
        _dom_characterdata_substring_data, _dom_characterdata_append_data, _dom_characterdata_insert_data,             \
        _dom_characterdata_delete_data, _dom_characterdata_replace_data
...
#define DOM_NODE_VTABLE_CHARACTERDATA                                                                                  \
    _dom_node_try_destroy, _dom_node_get_node_name, _dom_node_get_node_value, _dom_node_set_node_value,                \
        ...
        _dom_node_compare_document_position, _dom_characterdata_get_text_content, /* override */                       \
...
#define DOM_CHARACTERDATA_PROTECT_VTABLE _dom_characterdata_destroy, _dom_characterdata_copy
...
#define dom_characterdata_copy_internal(o, n)                                                                          \
    _dom_characterdata_copy_internal((dom_characterdata *)(o), (dom_characterdata *)(n))

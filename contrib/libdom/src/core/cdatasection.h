...
dom_exception
_dom_cdata_section_create(struct dom_document *doc, dom_string *name, dom_string *value, dom_cdata_section **result);
...
#define DOM_CDATA_SECTION_PROTECT_VTABLE __dom_cdata_section_destroy, _dom_cdata_section_copy

    ...
    dom_document *doc, dom_event_target *et, dom_event_target *related, dom_mutation_type change, bool *success)
{
    ...
    err = dom_mutation_event_init(evt, type, true, false, related, NULL, NULL, NULL, change);
    ...
    dom_document *doc, dom_event_target *et, dom_mutation_type change, bool *success)
{
    ...
    /* Initialise the event with corresponding parameters */
    err = dom_mutation_event_init(evt, type, true, false, NULL, NULL, NULL, NULL, change);
    dom_string_unref(type);
    if (err != DOM_NO_ERR)
        goto cleanup;
...
dom_exception __dom_dispatch_subtree_modified_event(dom_document *doc, dom_event_target *et, bool *success)
{
    ...
    err = dom_mutation_event_init(evt, type, true, false, et, NULL, NULL, NULL, DOM_MUTATION_MODIFICATION);
    dom_string_unref(type);
    if (err != DOM_NO_ERR) {
        goto cleanup;
    }

...
dom_exception
_dom_html_br_element_create(struct dom_html_element_create_params *params,
			    struct dom_html_br_element **ele);

/* Initialise a dom_html_br_element object */
dom_exception
_dom_html_br_element_initialise(struct dom_html_element_create_params *params,
				struct dom_html_br_element *ele);
...
dom_exception
_dom_html_br_element_copy(dom_node_internal *old, dom_node_internal **copy);
...
#define DOM_NODE_PROTECT_VTABLE_HTML_BR_ELEMENT                                \
	_dom_virtual_html_br_element_destroy, _dom_html_br_element_copy

/* Helper functions*/
dom_exception _dom_html_br_element_copy_internal(dom_html_br_element *old,
						 dom_html_br_element *new);
#define dom_html_br_element_copy_internal(o, n)                                \
	_dom_html_br_element_copy_internal((dom_html_br_element *)(o),         \

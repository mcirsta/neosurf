...
#define DOM_NODE_PROTECT_VTABLE_HTML_TABLE_ELEMENT                             \
	_dom_virtual_html_table_element_destroy, _dom_html_table_element_copy

/* Helper functions*/
dom_exception
_dom_html_table_element_copy_internal(dom_html_table_element *old,
				      dom_html_table_element *new);
#define dom_html_table_element_copy_internal(o, n)                             \
	_dom_html_table_element_copy_internal((dom_html_table_element *)(o),   \

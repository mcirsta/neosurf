...
dom_exception
_dom_html_menu_element_create(struct dom_html_element_create_params *params, struct dom_html_menu_element **ele);

/* Initialise a dom_html_menu_element object */
dom_exception
_dom_html_menu_element_initialise(struct dom_html_element_create_params *params, struct dom_html_menu_element *ele);
...
dom_exception
_dom_html_menu_element_parse_attribute(dom_element *ele, dom_string *name, dom_string *value, dom_string **parsed);
...
#define DOM_HTML_MENU_ELEMENT_PROTECT_VTABLE _dom_html_menu_element_parse_attribute

#define DOM_NODE_PROTECT_VTABLE_HTML_MENU_ELEMENT _dom_virtual_html_menu_element_destroy, _dom_html_menu_element_copy
...
#define dom_html_menu_element_copy_internal(o, n)                                                                      \
    _dom_html_menu_element_copy_internal((dom_html_menu_element *)(o), (dom_html_menu_element *)(n))

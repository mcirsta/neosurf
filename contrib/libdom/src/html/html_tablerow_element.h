...
#define DOM_HTML_TABLE_ROW_ELEMENT_PROTECT_VTABLE _dom_html_table_row_element_parse_attribute

#define DOM_NODE_PROTECT_VTABLE_HTML_TABLE_ROW_ELEMENT                                                                 \
    _dom_virtual_html_table_row_element_destroy, _dom_html_table_row_element_copy
...
#define dom_html_table_row_element_copy_internal(o, n)                                                                 \
    _dom_html_table_row_element_copy_internal((dom_html_table_row_element *)(o), (dom_html_table_row_element *)(n))

 ...
 * \param ele  The dom_html_paragraph_element object
 */
void _dom_html_paragraph_element_finalise(
	struct dom_html_paragraph_element *ele)
{
...
{
	_dom_html_paragraph_element_destroy(
		(struct dom_html_paragraph_element *)node);
}
...
dom_exception
_dom_html_paragraph_element_copy_internal(dom_html_paragraph_element *old,
...
#define SIMPLE_GET(attr)                                                       \
	dom_exception dom_html_paragraph_element_get_##attr(                   \
		dom_html_paragraph_element *element, dom_string **attr)        \
	{                                                                      \
		dom_exception ret;                                             \

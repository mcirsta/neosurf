 ...
 */
dom_exception
_dom_html_frame_element_create(struct dom_html_element_create_params *params,
						   ...
						   bool *no_resize)
{
	return dom_html_element_get_bool_property(
		&ele->base, "noresize", SLEN("noresize"), no_resize);
}
...
dom_exception
_dom_html_frame_element_copy(dom_node_internal *old, dom_node_internal **copy)
{
...
dom_exception _dom_html_frame_element_copy_internal(dom_html_frame_element *old,
...
#define SIMPLE_GET(attr)                                                       \
	dom_exception dom_html_frame_element_get_##attr(                       \
		dom_html_frame_element *element, dom_string **attr)            \
	{                                                                      \
		dom_exception ret;                                             \

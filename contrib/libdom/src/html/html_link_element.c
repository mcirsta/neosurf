 ...
 */
dom_exception
_dom_html_link_element_create(struct dom_html_element_create_params *params,
 ...
 */
dom_exception
_dom_html_link_element_initialise(struct dom_html_element_create_params *params,
				  struct dom_html_link_element *ele)
{
...
dom_exception
_dom_html_link_element_copy(dom_node_internal *old, dom_node_internal **copy)
{
...
dom_exception _dom_html_link_element_copy_internal(dom_html_link_element *old,
...
#define SIMPLE_GET_SET(attr)                                                   \
	dom_exception dom_html_link_element_get_##attr(                        \
		dom_html_link_element *element, dom_string **attr)             \
	{                                                                      \
		dom_exception ret;                                             \

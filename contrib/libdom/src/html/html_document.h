...
#define DOM_HTML_DOCUMENT_PROTECT_VTABLE                                       \
	_dom_html_document_destroy, _dom_html_document_copy
...
dom_exception
_dom_html_document_write(dom_html_document *doc, dom_string *text);
dom_exception
...
#define DOM_HTML_DOCUMENT_VTABLE                                               \
	_dom_html_document_get_title, _dom_html_document_set_title,            \
		_dom_html_document_get_referrer,                               \
		_dom_html_document_get_domain, _dom_html_document_get_url,     \
		_dom_html_document_get_body, _dom_html_document_set_body,      \
		_dom_html_document_get_images, _dom_html_document_get_applets, \
		_dom_html_document_get_links, _dom_html_document_get_forms,    \
		_dom_html_document_get_anchors, _dom_html_document_get_cookie, \
		_dom_html_document_set_cookie, _dom_html_document_open,        \
		_dom_html_document_close, _dom_html_document_write,            \
...
dom_exception _dom_html_document_create_element_ns(dom_document *doc,
						   ...
						   dom_element **result);
dom_exception
_dom_html_document_get_elements_by_tag_name(dom_document *doc,
					    dom_string *tagname,
					    dom_nodelist **result);
dom_exception
...
#define DOM_DOCUMENT_VTABLE_HTML                                               \
	_dom_document_get_doctype, _dom_document_get_implementation,           \
		_dom_document_get_document_element,                            \
		_dom_html_document_create_element,                             \
		_dom_document_create_document_fragment,                        \
		_dom_document_create_text_node, _dom_document_create_comment,  \
		...
		_dom_document_get_xml_version, _dom_document_set_xml_version,  \
		_dom_document_get_strict_error_checking,                       \
		_dom_document_set_strict_error_checking,                       \
		_dom_document_get_uri, _dom_document_set_uri,                  \
		_dom_document_adopt_node, _dom_document_get_dom_config,        \
		_dom_document_normalize, _dom_document_rename_node,            \

...
dom_exception
_dom_html_body_element_create(struct dom_html_element_create_params *params,
			      struct dom_html_body_element **ele);

/* Initialise a dom_html_body_element object */
dom_exception
_dom_html_body_element_initialise(struct dom_html_element_create_params *params,
				  struct dom_html_body_element *ele);
...
dom_exception
_dom_html_body_element_copy(dom_node_internal *old, dom_node_internal **copy);
...
/* Helper functions*/
dom_exception _dom_html_body_element_copy_internal(dom_html_body_element *old,
						   dom_html_body_element *new);
#define dom_html_body_element_copy_internal(o, n)                              \
	_dom_html_body_element_copy_internal((dom_html_body_element *)(o),     \

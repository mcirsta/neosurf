...
dom_exception _dom_html_text_area_element_create(
    struct dom_html_element_create_params *params, struct dom_html_text_area_element **ele);
...
dom_exception
_dom_html_text_area_element_parse_attribute(dom_element *ele, dom_string *name, dom_string *value, dom_string **parsed);
...
#define DOM_HTML_TEXT_AREA_ELEMENT_PROTECT_VTABLE _dom_html_text_area_element_parse_attribute

#define DOM_NODE_PROTECT_VTABLE_HTML_TEXT_AREA_ELEMENT                                                                 \
    _dom_virtual_html_text_area_element_destroy, _dom_html_text_area_element_copy

/* Helper functions*/
dom_exception
_dom_html_text_area_element_copy_internal(dom_html_text_area_element *old, dom_html_text_area_element *new);
#define dom_html_text_area_element_copy_internal(o, n)                                                                 \
    _dom_html_text_area_element_copy_internal((dom_html_text_area_element *)(o), (dom_html_text_area_element *)(n))

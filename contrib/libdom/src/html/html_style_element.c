 ...
 */
dom_exception
_dom_html_style_element_create(struct dom_html_element_create_params *params,
...
dom_exception
_dom_html_style_element_copy(dom_node_internal *old, dom_node_internal **copy)
{
...
dom_exception _dom_html_style_element_copy_internal(dom_html_style_element *old,
...
#define SIMPLE_GET(attr)                                                       \
	dom_exception dom_html_style_element_get_##attr(                       \
		dom_html_style_element *element, dom_string **attr)            \
	{                                                                      \
		dom_exception ret;                                             \
 ...
 */
dom_exception
dom_html_style_element_get_disabled(dom_html_style_element *ele, bool *disabled)
{

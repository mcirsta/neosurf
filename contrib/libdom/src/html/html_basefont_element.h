...
dom_exception _dom_html_base_font_element_create(
    struct dom_html_element_create_params *params, struct dom_html_base_font_element **ele);
...
dom_exception
_dom_html_base_font_element_parse_attribute(dom_element *ele, dom_string *name, dom_string *value, dom_string **parsed);
...
#define DOM_HTML_BASE_FONT_ELEMENT_PROTECT_VTABLE _dom_html_base_font_element_parse_attribute
...
/* Helper functions*/
dom_exception
_dom_html_base_font_element_copy_internal(dom_html_base_font_element *old, dom_html_base_font_element *new);
#define dom_html_base_font_element_copy_internal(o, n)                                                                 \
    _dom_html_base_font_element_copy_internal((dom_html_base_font_element *)(o), (dom_html_base_font_element *)(n))

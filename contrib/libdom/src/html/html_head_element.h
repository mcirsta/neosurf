...
dom_exception
_dom_html_head_element_create(struct dom_html_element_create_params *params,
			      struct dom_html_head_element **ele);

/* Initialise a dom_html_head_element object */
dom_exception
_dom_html_head_element_initialise(struct dom_html_element_create_params *params,
				  struct dom_html_head_element *ele);
...
dom_exception
_dom_html_head_element_copy(dom_node_internal *old, dom_node_internal **copy);
...
#define DOM_NODE_PROTECT_VTABLE_HTML_HEAD_ELEMENT                              \
	_dom_virtual_html_head_element_destroy, _dom_html_head_element_copy
...
#define dom_html_head_element_copy_internal(o, n)                              \
	_dom_html_head_element_copy_internal((dom_html_head_element *)(o),     \

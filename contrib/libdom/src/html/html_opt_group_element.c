 ...
 * \param ele  The dom_html_opt_group_element object
 */
void _dom_html_opt_group_element_finalise(
	struct dom_html_opt_group_element *ele)
{
 ...
 */
dom_exception
dom_html_opt_group_element_get_disabled(dom_html_opt_group_element *ele,
					bool *disabled)
{
 ...
 */
dom_exception
dom_html_opt_group_element_set_disabled(dom_html_opt_group_element *ele,
					bool disabled)
{
...
{
	_dom_html_opt_group_element_destroy(
		(struct dom_html_opt_group_element *)node);
}
...
dom_exception
_dom_html_opt_group_element_copy_internal(dom_html_opt_group_element *old,
...
#define SIMPLE_GET(attr)                                                       \
	dom_exception dom_html_opt_group_element_get_##attr(                   \
		dom_html_opt_group_element *element, dom_string **attr)        \
	{                                                                      \
		dom_exception ret;                                             \

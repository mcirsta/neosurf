 ...
 */
dom_exception
_dom_html_li_element_create(struct dom_html_element_create_params *params,
 ...
 */
dom_exception
_dom_html_li_element_initialise(struct dom_html_element_create_params *params,
				struct dom_html_li_element *ele)
{
 ...
 */
dom_exception
dom_html_li_element_get_value(dom_html_li_element *li, dom_long *value)
{
	return dom_html_element_get_int32_t_property(
		&li->base, "value", SLEN("value"), value);
}
 ...
 */
dom_exception
dom_html_li_element_set_value(dom_html_li_element *li, dom_long value)
{
...
dom_exception
_dom_html_li_element_copy(dom_node_internal *old, dom_node_internal **copy)
{
...
dom_exception _dom_html_li_element_copy_internal(dom_html_li_element *old,
...
#define SIMPLE_GET(attr)                                                       \
	dom_exception dom_html_li_element_get_##attr(                          \
		dom_html_li_element *element, dom_string **attr)               \
	{                                                                      \
		dom_exception ret;                                             \

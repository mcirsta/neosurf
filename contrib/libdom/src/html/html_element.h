...
#define DOM_ELEMENT_VTABLE_HTML_ELEMENT                                        \
	_dom_element_get_tag_name, _dom_html_element_get_attribute,            \
...
#define DOM_HTML_ELEMENT_PROTECT_VTABLE                                        \
	_dom_html_element_destroy, _dom_html_element_copy


/* The API functions */
dom_exception
_dom_html_element_get_id(dom_html_element *element, dom_string **id);
dom_exception
_dom_html_element_set_id(dom_html_element *element, dom_string *id);
dom_exception
_dom_html_element_get_title(dom_html_element *element, dom_string **title);
dom_exception
_dom_html_element_set_title(dom_html_element *element, dom_string *title);
dom_exception
_dom_html_element_get_lang(dom_html_element *element, dom_string **lang);
dom_exception
_dom_html_element_set_lang(dom_html_element *element, dom_string *lang);
dom_exception
_dom_html_element_get_dir(dom_html_element *element, dom_string **dir);
dom_exception
_dom_html_element_set_dir(dom_html_element *element, dom_string *dir);
...
#define DOM_HTML_ELEMENT_VTABLE                                                \
	_dom_html_element_get_id, _dom_html_element_set_id,                    \
		_dom_html_element_get_title, _dom_html_element_set_title,      \
		_dom_html_element_get_lang, _dom_html_element_set_lang,        \
		_dom_html_element_get_dir, _dom_html_element_set_dir,          \
...
#define dom_html_element_copy_internal(o, n)                                   \
	_dom_html_element_copy_internal((dom_html_element *)(o),               \
					(dom_html_element *)(n))

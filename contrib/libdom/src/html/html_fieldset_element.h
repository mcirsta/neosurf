...
#define DOM_HTML_FIELDSET_ELEMENT_PROTECT_VTABLE _dom_html_field_set_element_parse_attribute

#define DOM_NODE_PROTECT_VTABLE_HTML_FIELDSET_ELEMENT                                                                  \
    _dom_virtual_html_field_set_element_destroy, _dom_html_field_set_element_copy
...
#define dom_html_field_set_element_copy_internal(o, n)                                                                 \
    _dom_html_field_set_element_copy_internal((dom_html_field_set_element *)(o), (dom_html_field_set_element *)(n))

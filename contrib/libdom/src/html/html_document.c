...
dom_exception
_dom_html_document_copy(dom_node_internal *old, dom_node_internal **copy)
{
	UNUSED(old);
	UNUSED(copy);
 ...
 */
static inline dom_html_element_type
_dom_html_document_get_element_type(dom_html_document *html, dom_string *upper)
{
	...
	case 1:
		...
		else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_A) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_B) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_I) else RETURN_IF_MATCH(
			upper,
			DOM_HTML_ELEMENT_TYPE_S) else RETURN_IF_MATCH(upper,
								      DOM_HTML_ELEMENT_TYPE_U) else RETURN_IF_MATCH(upper,
														    DOM_HTML_ELEMENT_TYPE_Q) break;
	case 2:
		RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_EM)
		else RETURN_IF_MATCH(
			upper,
			DOM_HTML_ELEMENT_TYPE_LI) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_H1) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_H2) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_H3) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_H4) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_H5) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_H6) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_HR) else RETURN_IF_MATCH(upper,
																																																								 DOM_HTML_ELEMENT_TYPE_DD) else RETURN_IF_MATCH(upper,
																																																														DOM_HTML_ELEMENT_TYPE_DT) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_DL) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_UL) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_OL) else RETURN_IF_MATCH(upper,
																																																																																								 DOM_HTML_ELEMENT_TYPE_TD) else RETURN_IF_MATCH(upper,
																																																																																														DOM_HTML_ELEMENT_TYPE_TH) else RETURN_IF_MATCH(upper,
																																																																																																			       DOM_HTML_ELEMENT_TYPE_TR) else RETURN_IF_MATCH(upper,
																																																																																																									      DOM_HTML_ELEMENT_TYPE_BR) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_RP) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_RT) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_TT) break;
	case 3:
		RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_DIV)
																																													       ...
																																													       DOM_HTML_ELEMENT_TYPE_DIR) else RETURN_IF_MATCH(upper,
																																																			       DOM_HTML_ELEMENT_TYPE_SUB) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_SUP) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_DFN) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_KBD) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_NAV) else RETURN_IF_MATCH(upper,
																																																																																					   DOM_HTML_ELEMENT_TYPE_VAR) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_BDI) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_BDO) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_WBR) else RETURN_IF_MATCH(upper,
																																																																																																																DOM_HTML_ELEMENT_TYPE_BIG) break;
	case 4:
		RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_META)
		else RETURN_IF_MATCH(
			upper,
			DOM_HTML_ELEMENT_TYPE_CODE) else RETURN_IF_MATCH(upper,
									 DOM_HTML_ELEMENT_TYPE_SPAN) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_FORM) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_LINK) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_MENU) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_FONT) else RETURN_IF_MATCH(upper,
	...
	case 5:
		RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_INPUT)
			...
			upper,
			DOM_HTML_ELEMENT_TYPE_STYLE) else RETURN_IF_MATCH(upper,
									  DOM_HTML_ELEMENT_TYPE_THEAD) else RETURN_IF_MATCH(upper,
															    DOM_HTML_ELEMENT_TYPE_TBODY) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_TFOOT) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_LABEL) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_PARAM) else RETURN_IF_MATCH(upper,
																																																	   ...
																																																	   DOM_HTML_ELEMENT_TYPE_FRAME) else RETURN_IF_MATCH(upper,
																																																							     DOM_HTML_ELEMENT_TYPE_AUDIO) else RETURN_IF_MATCH(upper,
																																																													       DOM_HTML_ELEMENT_TYPE_ASIDE) else RETURN_IF_MATCH(upper,
																																																																				 DOM_HTML_ELEMENT_TYPE_EMBED) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_METER) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_SMALL) else RETURN_IF_MATCH(upper,
																																																																																								     DOM_HTML_ELEMENT_TYPE_TRACK) else RETURN_IF_MATCH(upper,
																																																																																														       DOM_HTML_ELEMENT_TYPE_VIDEO) break;
	case 6:
		RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_BUTTON)
			...
			upper,
			DOM_HTML_ELEMENT_TYPE_SCRIPT) else RETURN_IF_MATCH(upper,
									   DOM_HTML_ELEMENT_TYPE_IFRAME) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_LEGEND) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_SELECT) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_OBJECT) else RETURN_IF_MATCH(upper,
	...
	case 7:
		RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_CAPTION)
			...
			upper,
			DOM_HTML_ELEMENT_TYPE_ADDRESS) else RETURN_IF_MATCH(upper,
																						    ...
																						    DOM_HTML_ELEMENT_TYPE_PICTURE) else RETURN_IF_MATCH(upper,
																													DOM_HTML_ELEMENT_TYPE_SECTION) else RETURN_IF_MATCH(upper,
																																			    DOM_HTML_ELEMENT_TYPE_SUMMARY) else RETURN_IF_MATCH(upper,
																																										DOM_HTML_ELEMENT_TYPE_ACRONYM) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_BGSOUND) else RETURN_IF_MATCH(upper,
																																																							       DOM_HTML_ELEMENT_TYPE_MARQUEE) break;
	case 8:
		RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_TEXTAREA)
		else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_OPTGROUP) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_BASEFONT) else RETURN_IF_MATCH(
			upper,
									     ...
									     DOM_HTML_ELEMENT_TYPE_COLGROUP) else RETURN_IF_MATCH(upper,
																  DOM_HTML_ELEMENT_TYPE_FRAMESET) else RETURN_IF_MATCH(upper,
																						       DOM_HTML_ELEMENT_TYPE_DATALIST) else RETURN_IF_MATCH(upper,
																													    DOM_HTML_ELEMENT_TYPE_MENUITEM) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_NOSCRIPT) else RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_PROGRESS) else RETURN_IF_MATCH(upper,
																																																			 DOM_HTML_ELEMENT_TYPE_TEMPLATE) else RETURN_IF_MATCH(upper,
																																																									      DOM_HTML_ELEMENT_TYPE_NOFRAMES) break;
	case 10:
		RETURN_IF_MATCH(upper, DOM_HTML_ELEMENT_TYPE_BLOCKQUOTE)
		else RETURN_IF_MATCH(upper,
				     DOM_HTML_ELEMENT_TYPE_FIGCAPTION) break;
	}
					   ...
					   dom_html_element **result)
{
	...
	case DOM_HTML_ELEMENT_TYPE_HTML:
		exc = _dom_html_html_element_create(
			&params, (dom_html_html_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_HEAD:
		exc = _dom_html_head_element_create(
			&params, (dom_html_head_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_META:
		exc = _dom_html_meta_element_create(
			&params, (dom_html_meta_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_BASE:
		exc = _dom_html_base_element_create(
			&params, (dom_html_base_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_TITLE:
		exc = _dom_html_title_element_create(
			&params, (dom_html_title_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_BODY:
		exc = _dom_html_body_element_create(
			&params, (dom_html_body_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_DIV:
		exc = _dom_html_div_element_create(
			&params, (dom_html_div_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_FORM:
		exc = _dom_html_form_element_create(
			&params, (dom_html_form_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_LINK:
		exc = _dom_html_link_element_create(
			&params, (dom_html_link_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_BUTTON:
		exc = _dom_html_button_element_create(
			&params, (dom_html_button_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_INPUT:
		exc = _dom_html_input_element_create(
			&params, (dom_html_input_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_TEXTAREA:
		exc = _dom_html_text_area_element_create(
			&params, (dom_html_text_area_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_OPTGROUP:
		exc = _dom_html_opt_group_element_create(
			&params, (dom_html_opt_group_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_OPTION:
		exc = _dom_html_option_element_create(
			&params, (dom_html_option_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_SELECT:
		exc = _dom_html_select_element_create(
			&params, (dom_html_select_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_HR:
		exc = _dom_html_hr_element_create(
			&params, (dom_html_hr_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_DL:
		exc = _dom_html_dlist_element_create(
			&params, (dom_html_dlist_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_DIR:
		exc = _dom_html_directory_element_create(
			&params, (dom_html_directory_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_MENU:
		exc = _dom_html_menu_element_create(
			&params, (dom_html_menu_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_FIELDSET:
		exc = _dom_html_field_set_element_create(
			&params, (dom_html_field_set_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_LEGEND:
		exc = _dom_html_legend_element_create(
			&params, (dom_html_legend_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_P:
		exc = _dom_html_paragraph_element_create(
			&params, (dom_html_paragraph_element **)result);
		break;
	...
	case DOM_HTML_ELEMENT_TYPE_H6:
		exc = _dom_html_heading_element_create(
			&params, (dom_html_heading_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_BLOCKQUOTE:
	case DOM_HTML_ELEMENT_TYPE_Q:
		exc = _dom_html_quote_element_create(
			&params, (dom_html_quote_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_PRE:
		exc = _dom_html_pre_element_create(
			&params, (dom_html_pre_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_BR:
		exc = _dom_html_br_element_create(
			&params, (dom_html_br_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_LABEL:
		exc = _dom_html_label_element_create(
			&params, (dom_html_label_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_UL:
		exc = _dom_html_u_list_element_create(
			&params, (dom_html_u_list_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_OL:
		exc = _dom_html_olist_element_create(
			&params, (dom_html_olist_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_LI:
		exc = _dom_html_li_element_create(
			&params, (dom_html_li_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_FONT:
		exc = _dom_html_font_element_create(
			&params, (dom_html_font_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_DEL:
	case DOM_HTML_ELEMENT_TYPE_INS:
		exc = _dom_html_mod_element_create(
			&params, (dom_html_mod_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_A:
		exc = _dom_html_anchor_element_create(
			&params, (dom_html_anchor_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_BASEFONT:
		exc = _dom_html_base_font_element_create(
			&params, (dom_html_base_font_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_IMG:
		exc = _dom_html_image_element_create(
			&params, (dom_html_image_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_OBJECT:
		exc = _dom_html_object_element_create(
			&params, (dom_html_object_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_PARAM:
		exc = _dom_html_param_element_create(
			&params, (dom_html_param_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_APPLET:
		exc = _dom_html_applet_element_create(
			&params, (dom_html_applet_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_MAP:
		exc = _dom_html_map_element_create(
			&params, (dom_html_map_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_AREA:
		exc = _dom_html_area_element_create(
			&params, (dom_html_area_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_SCRIPT:
		exc = _dom_html_script_element_create(
			&params, (dom_html_script_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_CAPTION:
		exc = _dom_html_table_caption_element_create(
			&params, (dom_html_table_caption_element **)result);
		break;
	...
	case DOM_HTML_ELEMENT_TYPE_TH:
		 ...
		 * HTMLElement
		 */
		exc = _dom_html_table_cell_element_create(
			&params, (dom_html_table_cell_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_COL:
	case DOM_HTML_ELEMENT_TYPE_COLGROUP:
		exc = _dom_html_table_col_element_create(
			&params, (dom_html_table_col_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_THEAD:
	case DOM_HTML_ELEMENT_TYPE_TBODY:
	case DOM_HTML_ELEMENT_TYPE_TFOOT:
		exc = _dom_html_table_section_element_create(
			&params, (dom_html_table_section_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_TABLE:
		exc = _dom_html_table_element_create(
			&params, (dom_html_table_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_TR:
		exc = _dom_html_table_row_element_create(
			&params, (dom_html_table_row_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_STYLE:
		exc = _dom_html_style_element_create(
			&params, (dom_html_style_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_FRAMESET:
		exc = _dom_html_frame_set_element_create(
			&params, (dom_html_frame_set_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_FRAME:
		exc = _dom_html_frame_element_create(
			&params, (dom_html_frame_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_IFRAME:
		exc = _dom_html_iframe_element_create(
			&params, (dom_html_iframe_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_ISINDEX:
		exc = _dom_html_isindex_element_create(
			&params, (dom_html_isindex_element **)result);
		break;
	case DOM_HTML_ELEMENT_TYPE_CANVAS:
		exc = _dom_html_canvas_element_create(
			&params, (dom_html_canvas_element **)result);
		break;
						...
						dom_element **result)
{
	...
	return _dom_html_document_create_element_internal(
		html, tag_name, NULL, NULL, (dom_html_element **)result);
}
						   ...
						   dom_element **result)
{
	...
	err = _dom_html_document_create_element_internal(
		html,
		localname,
		namespace,
		prefix,
 ...
 */
dom_exception
_dom_html_document_get_elements_by_tag_name_ns(dom_document *doc,
					       dom_string *namespace,
 ...
 */
dom_exception
_dom_html_document_get_title(dom_html_document *doc, dom_string **title)
{
...
dom_exception
_dom_html_document_set_title(dom_html_document *doc, dom_string *title)
{
	if (doc->title != NULL)
		dom_string_unref(doc->title);
...
dom_exception
_dom_html_document_get_referrer(dom_html_document *doc, dom_string **referrer)
{
...
dom_exception
_dom_html_document_get_domain(dom_html_document *doc, dom_string **domain)
{
...
dom_exception
_dom_html_document_get_url(dom_html_document *doc, dom_string **url)
{
					  ...
					  struct dom_html_element **body)
{
	...
	if (doc->body != NULL) {
		*body = doc->body;
		...
		exc = dom_document_get_elements_by_tag_name(
			doc, doc->elements[DOM_HTML_ELEMENT_TYPE_BODY], &nodes);
		if (exc != DOM_NO_ERR) {
			return exc;
		}
...
bool images_callback(struct dom_node_internal *node, void *ctx)
{
	...
	if (node->type == DOM_ELEMENT_NODE &&
	    dom_string_caseless_isequal(
		    node->name, doc->elements[DOM_HTML_ELEMENT_TYPE_IMG])) {
		return true;
	}
	return false;
}
					    ...
					    struct dom_html_collection **col)
{
	...
	err = _dom_html_collection_create(
		doc, (dom_node_internal *)root, images_callback, doc, col);
	dom_node_unref(root);
	return err;
}
...
bool applet_callback(struct dom_node_internal *node, void *ctx)
{
	...
	if (node->type == DOM_ELEMENT_NODE &&
	    dom_string_caseless_isequal(
		    node->name, doc->elements[DOM_HTML_ELEMENT_TYPE_APPLET])) {
		return true;
	}
	return false;
}
...
bool applets_callback(struct dom_node_internal *node, void *ctx)
{
	...
	if (node->type == DOM_ELEMENT_NODE &&
	    dom_string_caseless_isequal(
		    node->name, doc->elements[DOM_HTML_ELEMENT_TYPE_OBJECT])) {
		uint32_t len = 0;
		dom_html_collection *applets;
		if (_dom_html_collection_create(
			    ctx, node, applet_callback, ctx, &applets) !=
		    DOM_NO_ERR)
			return false;
					     ...
					     struct dom_html_collection **col)
{
	...
	err = _dom_html_collection_create(
		doc, (dom_node_internal *)root, applets_callback, doc, col);
	dom_node_unref(root);
	return err;
}
...
bool links_callback(struct dom_node_internal *node, void *ctx)
{
	...
	if (node->type == DOM_ELEMENT_NODE &&
	    (dom_string_caseless_isequal(
		     node->name, doc->elements[DOM_HTML_ELEMENT_TYPE_A]) ||
	     dom_string_caseless_isequal(
		     node->name, doc->elements[DOM_HTML_ELEMENT_TYPE_AREA]))) {
		bool has_value = false;
		dom_exception err;

		err = dom_element_has_attribute(node,
						doc->memoised[hds_href],
						&has_value);
		if (err != DOM_NO_ERR)
			return err;
					   ...
					   struct dom_html_collection **col)
{
	...
	err = _dom_html_collection_create(
		doc, (dom_node_internal *)root, links_callback, doc, col);
	dom_node_unref(root);
	return err;
}
...
static bool __dom_html_document_node_is_form(dom_node_internal *node, void *ctx)
{
	...
	return dom_string_caseless_isequal(
		node->name, doc->elements[DOM_HTML_ELEMENT_TYPE_FORM]);
}
					   ...
					   struct dom_html_collection **col)
{
	...
	err = _dom_html_collection_create(doc,
					  ...
					  __dom_html_document_node_is_form,
					  NULL,
					  &result);
	if (err != DOM_NO_ERR) {
		dom_node_unref(root);
					     ...
					     struct dom_html_collection **col)
{
	...
	err = _dom_html_collection_create(
		doc, (dom_node_internal *)root, anchors_callback, doc, col);
	dom_node_unref(root);
	return err;
}

dom_exception
_dom_html_document_get_cookie(dom_html_document *doc, dom_string **cookie)
{
	UNUSED(doc);
	UNUSED(cookie);
...
dom_exception
_dom_html_document_set_cookie(dom_html_document *doc, dom_string *cookie)
{
	UNUSED(doc);
	UNUSED(cookie);
...
dom_exception
_dom_html_document_writeln(dom_html_document *doc, dom_string *text)
{
	UNUSED(doc);
	UNUSED(text);

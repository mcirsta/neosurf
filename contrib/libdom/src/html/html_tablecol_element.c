 ...
 * \param ele  The dom_html_table_col_element object
 */
void _dom_html_table_col_element_finalise(
	struct dom_html_table_col_element *ele)
{
				    ...
				    int32_t *span)
{
	return dom_html_element_get_int32_t_property(
		&table_col->base, "span", SLEN("span"), span);
}
...
{
	_dom_html_table_col_element_destroy(
		(struct dom_html_table_col_element *)node);
}
...
dom_exception
_dom_html_table_col_element_copy_internal(dom_html_table_col_element *old,
...
#define SIMPLE_GET(attr)                                                       \
	dom_exception dom_html_table_col_element_get_##attr(                   \
		dom_html_table_col_element *element, dom_string **attr)        \
	{                                                                      \
		dom_exception ret;                                             \

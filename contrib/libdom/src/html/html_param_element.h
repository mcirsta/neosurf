...
dom_exception
_dom_html_param_element_create(struct dom_html_element_create_params *params,
...
dom_exception
_dom_html_param_element_copy(dom_node_internal *old, dom_node_internal **copy);
...
#define DOM_NODE_PROTECT_VTABLE_HTML_PARAM_ELEMENT                             \
	_dom_virtual_html_param_element_destroy, _dom_html_param_element_copy

/* Helper functions*/
dom_exception
_dom_html_param_element_copy_internal(dom_html_param_element *old,
				      dom_html_param_element *new);
#define dom_html_param_element_copy_internal(o, n)                             \
	_dom_html_param_element_copy_internal((dom_html_param_element *)(o),   \

...
dom_exception _dom_html_table_cell_element_create(
    struct dom_html_element_create_params *params, struct dom_html_table_cell_element **ele);
...
dom_exception _dom_html_table_cell_element_parse_attribute(
...
#define DOM_HTML_TABLE_CELL_ELEMENT_PROTECT_VTABLE _dom_html_table_cell_element_parse_attribute

#define DOM_NODE_PROTECT_VTABLE_HTML_TABLE_CELL_ELEMENT                                                                \
    _dom_virtual_html_table_cell_element_destroy, _dom_html_table_cell_element_copy

/* Helper functions*/
dom_exception
_dom_html_table_cell_element_copy_internal(dom_html_table_cell_element *old, dom_html_table_cell_element *new);
#define dom_html_table_cell_element_copy_internal(o, n)                                                                \
    _dom_html_table_cell_element_copy_internal((dom_html_table_cell_element *)(o), (dom_html_table_cell_element *)(n))

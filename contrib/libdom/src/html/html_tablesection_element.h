...
dom_exception _dom_html_table_section_element_create(
    struct dom_html_element_create_params *params, struct dom_html_table_section_element **ele);
...
dom_exception _dom_html_table_section_element_parse_attribute(
...
dom_exception _dom_html_table_section_element_copy(dom_node_internal *old, dom_node_internal **copy);

#define DOM_HTML_TABLE_SECTION_ELEMENT_PROTECT_VTABLE _dom_html_table_section_element_parse_attribute

#define DOM_NODE_PROTECT_VTABLE_HTML_TABLE_SECTION_ELEMENT                                                             \
    _dom_virtual_html_table_section_element_destroy, _dom_html_table_section_element_copy

/* Helper functions*/
dom_exception
_dom_html_table_section_element_copy_internal(dom_html_table_section_element *old, dom_html_table_section_element *new);
#define dom_html_table_section_element_copy_internal(o, n)                                                             \
    _dom_html_table_section_element_copy_internal(                                                                     \
        (dom_html_table_section_element *)(o), (dom_html_table_section_element *)(n))

 ...
 */
dom_exception
_dom_html_u_list_element_create(struct dom_html_element_create_params *params,
 ...
 */
dom_exception
dom_html_u_list_element_get_compact(dom_html_u_list_element *u_list,
				    bool *compact)
{
	return dom_html_element_get_bool_property(
		&u_list->base, "compact", SLEN("compact"), compact);
}
 ...
 */
dom_exception
dom_html_u_list_element_set_compact(dom_html_u_list_element *u_list,
				    bool compact)
{
...
{
	_dom_html_u_list_element_destroy(
		(struct dom_html_u_list_element *)node);
}

/* The virtual copy function, see src/core/node.c for detail */
dom_exception
_dom_html_u_list_element_copy(dom_node_internal *old, dom_node_internal **copy)
{
...
dom_exception
_dom_html_u_list_element_copy_internal(dom_html_u_list_element *old,
...
#define SIMPLE_GET(attr)                                                       \
	dom_exception dom_html_u_list_element_get_##attr(                      \
		dom_html_u_list_element *element, dom_string **attr)           \
	{                                                                      \
		dom_exception ret;                                             \

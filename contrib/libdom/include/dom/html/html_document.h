...
dom_html_document_get_title(dom_html_document *doc, dom_string **title)
{
...
static inline dom_exception
dom_html_document_set_title(dom_html_document *doc, dom_string *title)
{
	return ((dom_html_document_vtable *)((dom_node *)doc)->vtable)
		->set_title(doc, title);
}
...
static inline dom_exception
dom_html_document_get_referrer(dom_html_document *doc, dom_string **referrer)
{
	return ((dom_html_document_vtable *)((dom_node *)doc)->vtable)
...
static inline dom_exception
dom_html_document_get_domain(dom_html_document *doc, dom_string **domain)
{
	return ((dom_html_document_vtable *)((dom_node *)doc)->vtable)
...
static inline dom_exception
dom_html_document_get_url(dom_html_document *doc, dom_string **url)
{
	return ((dom_html_document_vtable *)((dom_node *)doc)->vtable)
		->get_url(doc, url);
}
...
static inline dom_exception
dom_html_document_set_body(dom_html_document *doc,
			   struct dom_html_element *body)
{
	return ((dom_html_document_vtable *)((dom_node *)doc)->vtable)
		->set_body(doc, body);
...
static inline dom_exception
dom_html_document_get_images(dom_html_document *doc,
			     struct dom_html_collection **col)
{
	return ((dom_html_document_vtable *)((dom_node *)doc)->vtable)
		->get_images(doc, col);
...
static inline dom_exception
dom_html_document_get_applets(dom_html_document *doc,
			      struct dom_html_collection **col)
{
	return ((dom_html_document_vtable *)((dom_node *)doc)->vtable)
		->get_applets(doc, col);
...
static inline dom_exception
dom_html_document_get_links(dom_html_document *doc,
			    struct dom_html_collection **col)
{
	return ((dom_html_document_vtable *)((dom_node *)doc)->vtable)
		->get_links(doc, col);
...
static inline dom_exception
dom_html_document_get_forms(dom_html_document *doc,
			    struct dom_html_collection **col)
{
	return ((dom_html_document_vtable *)((dom_node *)doc)->vtable)
		->get_forms(doc, col);
...
static inline dom_exception
dom_html_document_get_cookie(dom_html_document *doc, dom_string **cookie)
{
	return ((dom_html_document_vtable *)((dom_node *)doc)->vtable)
...
static inline dom_exception
dom_html_document_set_cookie(dom_html_document *doc, dom_string *cookie)
{
	return ((dom_html_document_vtable *)((dom_node *)doc)->vtable)
...
static inline dom_exception
dom_html_document_write(dom_html_document *doc, dom_string *text)
{
	return ((dom_html_document_vtable *)((dom_node *)doc)->vtable)
		->write(doc, text);
}
...
static inline dom_exception
dom_html_document_writeln(dom_html_document *doc, dom_string *text)
{
	return ((dom_html_document_vtable *)((dom_node *)doc)->vtable)
		->writeln(doc, text);
}
...
static inline dom_exception
dom_html_document_get_elements_by_name(dom_html_document *doc,
				       dom_string *name,
				       struct dom_nodelist **list)
{
	return ((dom_html_document_vtable *)((dom_node *)doc)->vtable)

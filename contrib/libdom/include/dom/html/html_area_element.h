...
dom_exception
dom_html_area_element_get_alt(dom_html_area_element *area, dom_string **alt);

dom_exception
dom_html_area_element_set_alt(dom_html_area_element *area, dom_string *alt);
...
dom_exception
dom_html_area_element_get_href(dom_html_area_element *area, dom_string **href);

dom_exception
dom_html_area_element_set_href(dom_html_area_element *area, dom_string *href);
...
dom_exception
dom_html_area_element_set_shape(dom_html_area_element *area, dom_string *shape);

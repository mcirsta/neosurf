...
dom_exception
dom_html_table_element_get_caption(dom_html_table_element *element, dom_html_table_caption_element **caption);

dom_exception
dom_html_table_element_set_caption(dom_html_table_element *element, dom_html_table_caption_element *caption);

dom_exception
dom_html_table_element_get_t_head(dom_html_table_element *element, dom_html_table_section_element **t_head);

dom_exception
dom_html_table_element_set_t_head(dom_html_table_element *element, dom_html_table_section_element *t_head);

dom_exception
dom_html_table_element_get_t_foot(dom_html_table_element *element, dom_html_table_section_element **t_foot);

dom_exception
dom_html_table_element_set_t_foot(dom_html_table_element *element, dom_html_table_section_element *t_foot);
...
dom_exception
dom_html_table_element_insert_row(dom_html_table_element *element, int32_t index, dom_html_element **row_out);

...
dom_exception
dom_html_table_element_get_caption(dom_html_table_element *element,
				   dom_html_table_caption_element **caption);

dom_exception
dom_html_table_element_set_caption(dom_html_table_element *element,
				   dom_html_table_caption_element *caption);

dom_exception
dom_html_table_element_get_t_head(dom_html_table_element *element,
				  dom_html_table_section_element **t_head);

dom_exception
dom_html_table_element_set_t_head(dom_html_table_element *element,
				  dom_html_table_section_element *t_head);

dom_exception
dom_html_table_element_get_t_foot(dom_html_table_element *element,
				  dom_html_table_section_element **t_foot);

dom_exception
dom_html_table_element_set_t_foot(dom_html_table_element *element,
				  dom_html_table_section_element *t_foot);
...
dom_exception
dom_html_table_element_get_cell_padding(dom_html_table_element *table,
					dom_string **cell_padding);

dom_exception
dom_html_table_element_set_cell_padding(dom_html_table_element *table,
					dom_string *cell_padding);

dom_exception
dom_html_table_element_get_cell_spacing(dom_html_table_element *table,
					dom_string **cell_spacing);

dom_exception
dom_html_table_element_set_cell_spacing(dom_html_table_element *table,
					dom_string *cell_spacing);

...
dom_exception
dom__html_select_element_get_options(dom_html_select_element *ele, struct dom_html_options_collection **col);
#define dom_html_select_element_get_options(e, c)                                                                      \
    dom__html_select_element_get_options((dom_html_select_element *)(e), (struct dom_html_options_collection **)(c))
...
/* Functions */
dom_exception dom__html_select_element_add(
    dom_html_select_element *select, struct dom_html_element *ele, struct dom_html_element *before);
#define dom_html_select_element_add(s, e, b)                                                                           \
    dom__html_select_element_add(                                                                                      \
        (dom_html_select_element *)(s), (struct dom_html_element *)(e), (struct dom_html_element *)(b))

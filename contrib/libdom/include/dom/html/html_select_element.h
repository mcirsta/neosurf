...
dom_exception dom_html_select_element_get_form(dom_html_select_element *ele,
...
dom_exception
dom_html_select_element_focus(struct dom_html_select_element *ele);

...
#define dom_ui_event_get_view(e, v)                                            \
	_dom_ui_event_get_view((dom_ui_event *)(e),                            \
...
#define dom_ui_event_get_detail(e, d)                                          \
	_dom_ui_event_get_detail((dom_ui_event *)(e), (int32_t *)(d))
...
#define dom_ui_event_init(e, t, b, c, v, d)                                    \
	_dom_ui_event_init((dom_ui_event *)(e),                                \
			   (dom_string *)(t),                                  \
			   (bool)(b),                                          \
			   (bool)(c),                                          \
			   (struct dom_abstract_view *)(v),                    \
...
#define dom_ui_event_init_ns(e, n, t, b, c, v, d)                              \
	_dom_ui_event_init_ns((dom_ui_event *)(e),                             \
			      (dom_string *)(n),                               \
			      (dom_string *)(t),                               \
			      (bool)(b),                                       \
			      (bool)(c),                                       \

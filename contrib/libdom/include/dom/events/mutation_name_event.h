...
#define dom_mutation_name_event_get_prev_namespace(e, n)                                                               \
    _dom_mutation_name_event_get_prev_namespace((dom_mutation_name_event *)(e), (dom_string **)(n))
...
#define dom_mutation_name_event_get_prev_node_name(e, n)                                                               \
    _dom_mutation_name_event_get_prev_node_name((dom_mutation_name_event *)(e), (dom_string **)(n))
...
#define dom_mutation_name_event_init(e, t, b, c, n, p, pn)                                                             \
    _dom_mutation_name_event_init((dom_mutation_name_event *)(e), (dom_string *)(t), (bool)(b), (bool)(c),             \
        (struct dom_node *)(n), (dom_string *)(p), (dom_string *)(pn))
...
#define dom_mutation_name_event_init_ns(e, n, t, b, c, nv, p, pn)                                                      \
    _dom_mutation_name_event_init_ns((dom_mutation_name_event *)(e), (dom_string *)(n), (dom_string *)(t), (bool)(b),  \
        (bool)(c), (struct dom_node *)(nv), (dom_string *)(p), (dom_string *)(pn))

...
#define dom_keyboard_event_get_location(e, l)                                  \
	_dom_keyboard_event_get_location((dom_keyboard_event *)(e),            \
					 (dom_key_location *)(l))

dom_exception
_dom_keyboard_event_get_ctrl_key(dom_keyboard_event *evt, bool *key);
#define dom_keyboard_event_get_ctrl_key(e, k)                                  \
	_dom_keyboard_event_get_ctrl_key((dom_keyboard_event *)(e), (bool *)(k))
...
#define dom_keyboard_event_get_alt_key(e, k)                                   \
	_dom_keyboard_event_get_alt_key((dom_keyboard_event *)(e), (bool *)(k))

dom_exception
_dom_keyboard_event_get_meta_key(dom_keyboard_event *evt, bool *key);
#define dom_keyboard_event_get_meta_key(e, k)                                  \
	_dom_keyboard_event_get_meta_key((dom_keyboard_event *)(e), (bool *)(k))
...
#define dom_keyboard_event_init(                                               \
	e, t, b, c, v, kk, kc, kl, ck, sk, ak, mk, r, ic)                      \

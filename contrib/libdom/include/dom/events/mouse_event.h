...
dom_exception _dom_mouse_event_init(dom_mouse_event *evt,
				    ...
				    dom_event_target *et);
#define dom_mouse_event_init(                                                  \
	e, t, b, c, v, d, sx, sy, cx, cy, ctrl, alt, shift, meta, button, et)  \

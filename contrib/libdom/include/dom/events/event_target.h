...
typedef struct dom_event_target_vtable {
	dom_exception (*add_event_listener)(dom_event_target *et,
					    dom_string *type,
	...
	dom_exception (*remove_event_listener)(
		...
		struct dom_event_listener *listener,
		bool capture);
	dom_exception (*dispatch_event)(dom_event_target *et,
				    ...
				    bool capture)
{
	return ((dom_event_target_vtable *)et->vtable)
		->add_event_listener(et, type, listener, capture);
}
...
{
	return ((dom_event_target_vtable *)et->vtable)
		->remove_event_listener(et, type, listener, capture);
}
...
{
	return ((dom_event_target_vtable *)et->vtable)
		->add_event_listener_ns(et, namespace, type, listener, capture);
}

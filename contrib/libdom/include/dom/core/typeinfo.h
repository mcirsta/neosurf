...
#define dom_type_info_get_type_name(t, r)                                      \
	_dom_type_info_get_type_name((dom_type_info *)(t), (r))


dom_exception
_dom_type_info_get_type_namespace(dom_type_info *ti, dom_string **ret);
...
#define dom_type_info_is_derived(t, s, n, m, r)                                \
	_dom_type_info_is_derived((dom_type_info *)(t),                        \
				  (s),                                         \
				  (n),                                         \
				  (dom_type_info_derivation_method)(m),        \
				  (bool *)(r))

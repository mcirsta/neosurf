...
#define dom_namednodemap_get_named_item(m, n, r)                                                                       \
    _dom_namednodemap_get_named_item((dom_namednodemap *)(m), (n), (dom_node **)(r))


dom_exception
_dom_namednodemap_set_named_item(struct dom_namednodemap *map, struct dom_node *arg, struct dom_node **node);

#define dom_namednodemap_set_named_item(m, a, n)                                                                       \
    _dom_namednodemap_set_named_item((dom_namednodemap *)(m), (dom_node *)(a), (dom_node **)(n))


dom_exception
_dom_namednodemap_remove_named_item(struct dom_namednodemap *map, dom_string *name, struct dom_node **node);

#define dom_namednodemap_remove_named_item(m, n, r)                                                                    \
    _dom_namednodemap_remove_named_item((dom_namednodemap *)(m), (n), (dom_node **)(r))


dom_exception _dom_namednodemap_item(struct dom_namednodemap *map, dom_ulong index, struct dom_node **node);

#define dom_namednodemap_item(m, i, n) _dom_namednodemap_item((dom_namednodemap *)(m), (uint32_t)(i), (dom_node **)(n))


dom_exception _dom_namednodemap_get_named_item_ns(
    struct dom_namednodemap *map, dom_string *namespace, dom_string *localname, struct dom_node **node);

#define dom_namednodemap_get_named_item_ns(m, n, l, r)                                                                 \
    _dom_namednodemap_get_named_item_ns((dom_namednodemap *)(m), (n), (l), (dom_node **)(r))


dom_exception
_dom_namednodemap_set_named_item_ns(struct dom_namednodemap *map, struct dom_node *arg, struct dom_node **node);

#define dom_namednodemap_set_named_item_ns(m, a, n)                                                                    \
    _dom_namednodemap_set_named_item_ns((dom_namednodemap *)(m), (dom_node *)(a), (dom_node **)(n))
...
#define dom_namednodemap_remove_named_item_ns(m, n, l, r)                                                              \
    _dom_namednodemap_remove_named_item_ns((dom_namednodemap *)(m), (n), (l), (dom_node **)(r))

...
typedef struct dom_element_vtable {
	...
	dom_exception (*dom_element_get_classes)(struct dom_element *element,
						 lwc_string ***classes,
						 uint32_t *n_classes);
	dom_exception (*dom_element_has_class)(struct dom_element *element,
					       lwc_string *name,
					       bool *match);
} dom_element_vtable;

static inline dom_exception
dom_element_get_tag_name(struct dom_element *element, dom_string **name)
{
...
#define dom_element_get_tag_name(e, n)                                         \
	dom_element_get_tag_name((dom_element *)(e), (n))

static inline dom_exception
dom_element_get_attribute(struct dom_element *element,
			  dom_string *name,
			  dom_string **value)
{
	return ((dom_element_vtable *)((dom_node *)element)->vtable)
...
#define dom_element_get_attribute(e, n, v)                                     \
	dom_element_get_attribute((dom_element *)(e), (n), (v))

static inline dom_exception
dom_element_set_attribute(struct dom_element *element,
			  dom_string *name,
			  dom_string *value)
{
	return ((dom_element_vtable *)((dom_node *)element)->vtable)
...
#define dom_element_set_attribute(e, n, v)                                     \
	dom_element_set_attribute((dom_element *)(e), (n), (v))

static inline dom_exception
dom_element_remove_attribute(struct dom_element *element, dom_string *name)
{
	return ((dom_element_vtable *)((dom_node *)element)->vtable)
		->dom_element_remove_attribute(element, name);
}
#define dom_element_remove_attribute(e, n)                                     \
	dom_element_remove_attribute((dom_element *)(e), (n))

static inline dom_exception
dom_element_get_attribute_node(struct dom_element *element,
			       dom_string *name,
			       struct dom_attr **result)
{
	return ((dom_element_vtable *)((dom_node *)element)->vtable)
...
static inline dom_exception
dom_element_set_attribute_node(struct dom_element *element,
			       struct dom_attr *attr,
			       struct dom_attr **result)
{
	return ((dom_element_vtable *)((dom_node *)element)->vtable)
...
static inline dom_exception
dom_element_remove_attribute_node(struct dom_element *element,
				  struct dom_attr *attr,
				  struct dom_attr **result)
{
	return ((dom_element_vtable *)((dom_node *)element)->vtable)
...
static inline dom_exception
dom_element_get_elements_by_tag_name(struct dom_element *element,
				     dom_string *name,
				     struct dom_nodelist **result)
{
	return ((dom_element_vtable *)((dom_node *)element)->vtable)
...
static inline dom_exception
dom_element_get_attribute_ns(struct dom_element *element,
			     dom_string *namespace,
			     dom_string *localname,
			     dom_string **value)
{
	return ((dom_element_vtable *)((dom_node *)element)->vtable)
		->dom_element_get_attribute_ns(
			element, namespace, localname, value);
}
#define dom_element_get_attribute_ns(e, n, l, v)                               \
	dom_element_get_attribute_ns((dom_element *)(e), (n), (l), (v))

static inline dom_exception
dom_element_set_attribute_ns(struct dom_element *element,
			     dom_string *namespace,
			     dom_string *qname,
			     dom_string *value)
{
	return ((dom_element_vtable *)((dom_node *)element)->vtable)
		->dom_element_set_attribute_ns(
			element, namespace, qname, value);
}
#define dom_element_set_attribute_ns(e, n, l, v)                               \
	dom_element_set_attribute_ns((dom_element *)(e), (n), (l), (v))


static inline dom_exception
dom_element_remove_attribute_ns(struct dom_element *element,
				dom_string *namespace,
				dom_string *localname)
{
	return ((dom_element_vtable *)((dom_node *)element)->vtable)
		->dom_element_remove_attribute_ns(element,
						  namespace,
						  localname);
}
#define dom_element_remove_attribute_ns(e, n, l)                               \
	dom_element_remove_attribute_ns((dom_element *)(e), (n), (l))


static inline dom_exception
dom_element_get_attribute_node_ns(struct dom_element *element,
				  dom_string *namespace,
				  dom_string *localname,
				  struct dom_attr **result)
{
...
#define dom_element_get_attribute_node_ns(e, n, l, r)                          \
	dom_element_get_attribute_node_ns(                                     \
		(dom_element *)(e), (n), (l), (struct dom_attr **)(r))

static inline dom_exception
dom_element_set_attribute_node_ns(struct dom_element *element,
				  struct dom_attr *attr,
				  struct dom_attr **result)
{
	return ((dom_element_vtable *)((dom_node *)element)->vtable)
...
static inline dom_exception
dom_element_get_elements_by_tag_name_ns(struct dom_element *element,
					dom_string *namespace,
					dom_string *localname,
					struct dom_nodelist **result)
{
...
#define dom_element_get_elements_by_tag_name_ns(e, n, l, r)                    \
	dom_element_get_elements_by_tag_name_ns(                               \
		(dom_element *)(e), (n), (l), (struct dom_nodelist **)(r))

static inline dom_exception
dom_element_has_attribute(struct dom_element *element,
			  dom_string *name,
			  bool *result)
{
	return ((dom_element_vtable *)((dom_node *)element)->vtable)
...
#define dom_element_has_attribute(e, n, r)                                     \
	dom_element_has_attribute((dom_element *)(e), (n), (bool *)(r))

static inline dom_exception
dom_element_has_attribute_ns(struct dom_element *element,
			     dom_string *namespace,
			     dom_string *localname,
			     bool *result)
{
...
#define dom_element_has_attribute_ns(e, n, l, r)                               \
	dom_element_has_attribute_ns((dom_element *)(e), (n), (l), (bool *)(r))

static inline dom_exception
dom_element_get_schema_type_info(struct dom_element *element,
				 struct dom_type_info **result)
{
	return ((dom_element_vtable *)((dom_node *)element)->vtable)
...
static inline dom_exception
dom_element_set_id_attribute(struct dom_element *element,
			     dom_string *name,
			     bool is_id)
{
	return ((dom_element_vtable *)((dom_node *)element)->vtable)
...
#define dom_element_set_id_attribute(e, n, i)                                  \
	dom_element_set_id_attribute((dom_element *)(e), (n), (bool)(i))

static inline dom_exception
dom_element_set_id_attribute_ns(struct dom_element *element,
				dom_string *namespace,
				dom_string *localname,
				bool is_id)
{
...
static inline dom_exception dom_element_get_classes(struct dom_element *element,
						    lwc_string ***classes,
						    uint32_t *n_classes)
{
	return ((dom_element_vtable *)((dom_node *)element)->vtable)
...
static inline dom_exception dom_element_has_class(struct dom_element *element,
						  lwc_string *name,
						  bool *match)
{
	return ((dom_element_vtable *)((dom_node *)element)->vtable)

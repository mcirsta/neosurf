...
#define get_next_domnodelist(l, i, r) _get_next_domnodelist((dom_nodelist *)(l), (unsigned int *)(i), (dom_node **)(r))
...
#define get_next_domnamednodemap(m, i, r)                                                                              \
    _get_next_domnamednodemap((dom_namednodemap *)(m), (unsigned int *)(i), (dom_node **)(r))
...
#define get_next_domhtmlcollection(c, i, r)                                                                            \
    _get_next_domhtmlcollection((dom_html_collection *)(c), (unsigned int *)(i), (dom_node **)(r))

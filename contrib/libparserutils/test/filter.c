...
int main(int argc, char **argv)
{
	...
	assert(parserutils__filter_process_chunk(
		       input, &in, &inlen, &out, &outlen) == PARSERUTILS_OK);
	...
	assert(parserutils__filter_process_chunk(
		       input, &in, &inlen, &out, &outlen) == PARSERUTILS_NOMEM);

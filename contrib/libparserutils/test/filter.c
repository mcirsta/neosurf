...
int main(int argc, char **argv)
{
    ...
    assert(parserutils__filter_setopt(
               input, PARSERUTILS_FILTER_SET_ENCODING, (parserutils_filter_optparams *)&params) == PARSERUTILS_OK);
    ...
    assert(parserutils__filter_process_chunk(input, &in, &inlen, &out, &outlen) == PARSERUTILS_OK);

    printf("'%.*s' %d '%.*s' %d\n", (int)inlen, in, (int)inlen, (int)(out - ((uint8_t *)outbuf)), outbuf, (int)outlen);

    assert(parserutils__filter_reset(input) == PARSERUTILS_OK);

    assert(memcmp(outbuf, "hell\xc2\xa0o!", SLEN("hell\xc2\xa0o!")) == 0);
    ...
    assert(parserutils__filter_process_chunk(input, &in, &inlen, &out, &outlen) == PARSERUTILS_NOMEM);
    ...
    assert(memcmp(outbuf, "hello!", SLEN("hello!")) == 0);
    ...
    assert(memcmp(outbuf, "hell\xef\xbf\xbdo!", SLEN("hell\xef\xbf\xbdo!")) == 0);
    ...
    assert(memcmp(outbuf, "hell\xef\xbf\xbd\xef\xbf\xbdo!", SLEN("hell\xef\xbf\xbd\xef\xbf\xbdo!")) == 0);
    ...
    assert(memcmp(outbuf, "hell\xc2\xa0\xc2\xa1o!", SLEN("hell\xc2\xa0\xc2\xa1o!")) == 0);
    ...
    assert(memcmp(outbuf, "hell\xe2\x80\xa2o!", SLEN("hell\xe2\x80\xa2o!")) == 0);

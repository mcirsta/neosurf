...
static int parserutils_charset_alias_match(const void *a, const void *b)
{
	...
	parserutils_charset_aliases_alias *alias =
		(parserutils_charset_aliases_alias *)b;
...
parserutils__charset_alias_canonicalise(const char *alias, size_t len)
{
	...
	c = (parserutils_charset_aliases_alias *)bsearch(
		&s,
		&charset_aliases[0],

...
css_error
css__stylesheet_style_create(css_stylesheet *sheet, css_style **style);
...
css_stylesheet_style_inherit(css_style *style, opcode_t opcode)
{
	return css__stylesheet_style_append(style,
...
static inline css_error
css_stylesheet_style_initial(css_style *style, opcode_t opcode)
{
	return css__stylesheet_style_append(style,
...
/** Helper function to set inherit generic value */
static inline css_error
css_stylesheet_style_revert(css_style *style, opcode_t opcode)
{
	style->sheet->uses_revert = true;
	return css__stylesheet_style_append(style,
...
/** Helper function to set initial generic value */
static inline css_error
css_stylesheet_style_unset(css_style *style, opcode_t opcode)
{
	return css__stylesheet_style_append(style,
...
/** Helper function to set initial generic value */
static inline css_error
css_stylesheet_style_flag_value(css_style *style,
...
css__stylesheet_selector_append_specific(css_stylesheet *sheet,
					 css_selector **parent,
					 const css_selector_detail *specific);

...
css_error css__cascade_border_left_color(uint32_t opv,
					 css_style *style,
					 css_select_state *state)
{
	return css__cascade_bg_border_color(
		opv, style, state, set_border_left_color);
}
...
css_error css__copy_border_left_color(const css_computed_style *from,

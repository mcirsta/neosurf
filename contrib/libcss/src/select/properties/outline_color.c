...
css_error css__cascade_outline_color(uint32_t opv,
				     css_style *style,
...
css_error
css__copy_outline_color(const css_computed_style *from, css_computed_style *to)
{
	css_color color = 0;
				     ...
				     css_computed_style *result)
{
	...
	return css__copy_outline_color(
		type == CSS_OUTLINE_COLOR_INHERIT ? parent : child, result);
}

...
css_error css__cascade_list_style_type(uint32_t opv,
				       css_style *style,
...
css_error css__copy_list_style_type(const css_computed_style *from,
				       ...
				       css_computed_style *result)
{
	...
	return css__copy_list_style_type(
		type == CSS_LIST_STYLE_TYPE_INHERIT ? parent : child, result);
}

...
css_error
css__cascade_flex_wrap(uint32_t opv, css_style *style, css_select_state *state)
{
...
css_error
css__copy_flex_wrap(const css_computed_style *from, css_computed_style *to)
{
				 ...
				 css_computed_style *result)
{
	...
	return css__copy_flex_wrap(
		type == CSS_FLEX_WRAP_INHERIT ? parent : child, result);
}

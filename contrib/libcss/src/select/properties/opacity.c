...
css_error
css__cascade_opacity(uint32_t opv, css_style *style, css_select_state *state)
{
...
css_error
css__copy_opacity(const css_computed_style *from, css_computed_style *to)
{
	css_fixed opacity = 0;
			       ...
			       css_computed_style *result)
{
	...
	return css__copy_opacity(type == CSS_OPACITY_INHERIT ? parent : child,
				 result);
}

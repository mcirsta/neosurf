...
css_error css__cascade_border_top_style(uint32_t opv,
					css_style *style,
					css_select_state *state)
{
	return css__cascade_border_style(
		opv, style, state, set_border_top_style);
}
...
css_error css__copy_border_top_style(const css_computed_style *from,

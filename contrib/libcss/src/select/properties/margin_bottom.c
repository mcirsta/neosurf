...
css_error css__cascade_margin_bottom(uint32_t opv,
				     css_style *style,
...
{
	return set_margin_bottom(style,
				 hint->status,
...
css_error
css__copy_margin_bottom(const css_computed_style *from, css_computed_style *to)
{
	css_fixed length = 0;

...
css_error
css__cascade_quotes(uint32_t opv, css_style *style, css_select_state *state)
{
...
css_error
css__copy_quotes(const css_computed_style *from, css_computed_style *to)
{
	css_error error;
			      ...
			      css_computed_style *result)
{
	...
	return css__copy_quotes(type == CSS_QUOTES_INHERIT ? parent : child,
				result);
}

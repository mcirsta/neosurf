...
css_error
css__cascade_clip(uint32_t opv, css_style *style, css_select_state *state)
{
...
css_error
css__set_clip_from_hint(const css_hint *hint, css_computed_style *style)
{
			    ...
			    css_computed_style *result)
{
	...
	return css__copy_clip(type == CSS_CLIP_INHERIT ? parent : child,
			      result);
}

...
css_error css__cascade_padding_right(uint32_t opv,
				     css_style *style,
...
{
	return set_padding_right(style,
				 hint->status,
...
css_error
css__copy_padding_right(const css_computed_style *from, css_computed_style *to)
{
	css_fixed length = 0;

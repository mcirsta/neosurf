...
hubbub_error
handle_before_html(hubbub_treebuilder *treebuilder, const hubbub_token *token);
hubbub_error
...
hubbub_error
handle_after_head(hubbub_treebuilder *treebuilder, const hubbub_token *token);
hubbub_error
handle_in_body(hubbub_treebuilder *treebuilder, const hubbub_token *token);
hubbub_error
handle_in_table(hubbub_treebuilder *treebuilder, const hubbub_token *token);
hubbub_error
handle_in_caption(hubbub_treebuilder *treebuilder, const hubbub_token *token);
...
hubbub_error handle_in_table_body(hubbub_treebuilder *treebuilder,
				  const hubbub_token *token);
hubbub_error
handle_in_row(hubbub_treebuilder *treebuilder, const hubbub_token *token);
hubbub_error
handle_in_cell(hubbub_treebuilder *treebuilder, const hubbub_token *token);
hubbub_error
handle_in_select(hubbub_treebuilder *treebuilder, const hubbub_token *token);

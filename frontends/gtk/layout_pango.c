 ...
 */
static nserror
layout_position(PangoLayout *layout, const char *string, size_t length, int x, size_t *string_idx, int *actual_x)
{
    int index;
    PangoRectangle pos;
...
static nserror nsfont_split(
    const plot_font_style_t *fstyle, const char *string, size_t length, int x, size_t *string_idx, int *actual_x)
{
    nserror res;

...
GdkPixbuf *nsgdk_pixbuf_get_from_surface(cairo_surface_t *surface, int scwidth, int scheight)
{
    ...
    memset(gdk_pixbuf_get_pixels(pixbuf), 0xff, gdk_pixbuf_get_rowstride(pixbuf) * (size_t)scheight);
    ...
    convert_alpha(gdk_pixbuf_get_pixels(pixbuf), gdk_pixbuf_get_rowstride(pixbuf),
        cairo_image_surface_get_data(scsurface), cairo_image_surface_get_stride(scsurface), scwidth, scheight);

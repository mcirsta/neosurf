...
#ifndef WISP_PLOT_STYLE_H
#define WISP_PLOT_STYLE_H
...
#define half_darken_colour(c1) ((((7 * (c1 & 0xff00ff)) >> 3) & 0xff00ff) | (((7 * (c1 & 0x00ff00)) >> 3) & 0x00ff00))

/* Darken a colour by taking three quarters of each channel's intensity */
#define darken_colour(c1) ((((3 * (c1 & 0xff00ff)) >> 2) & 0xff00ff) | (((3 * (c1 & 0x00ff00)) >> 2) & 0x00ff00))

/* Darken a colour by taking nine sixteenths of each channel's intensity */
#define double_darken_colour(c1) ((((9 * (c1 & 0xff00ff)) >> 4) & 0xff00ff) | (((9 * (c1 & 0x00ff00)) >> 4) & 0x00ff00))
...
#define half_lighten_colour(c1)                                                                                        \
    (((((7 * (c1 & 0xff00ff)) >> 3) + 0x200020) & 0xff00ff) | ((((7 * (c1 & 0x00ff00)) >> 3) + 0x002000) & 0x00ff00))
...
#define lighten_colour(c1)                                                                                             \
    (((((3 * (c1 & 0xff00ff)) >> 2) + 0x400040) & 0xff00ff) | ((((3 * (c1 & 0x00ff00)) >> 2) + 0x004000) & 0x00ff00))
...
#define double_lighten_colour(c1)                                                                                      \
    (((((9 * (c1 & 0xff00ff)) >> 4) + 0x700070) & 0xff00ff) | ((((9 * (c1 & 0x00ff00)) >> 4) + 0x007000) & 0x00ff00))
...
#define blend_colour(c0, c1)                                                                                           \
    (((((c0 & 0xff00ff) + (c1 & 0xff00ff)) >> 1) & 0xff00ff) | ((((c0 & 0x00ff00) + (c1 & 0x00ff00)) >> 1) & 0x00ff00))
...
#define colour_lightness(c0)                                                                                           \
    ((((c0 & 0x0000ff) * 77) >> 8) + (((c0 & 0x00ff00) * 151) >> 16) + (((c0 & 0xff0000) * 30) >> 24))
...
#define mix_colour(c0, c1, p)                                                                                          \
    ((((((c1 & 0xff00ff) * (255 - p)) + ((c0 & 0xff00ff) * (p))) >> 8) & 0xff00ff) |                                   \
        (((((c1 & 0x00ff00) * (255 - p)) + ((c0 & 0x00ff00) * (p))) >> 8) & 0x00ff00))
...
#define colour_rb_swap(c) (((0x000000ff & c) << 16) | ((0x0000ff00 & c)) | ((0x00ff0000 & c) >> 16))
 ...
 */
static inline colour colour_engorge_component(colour col, bool dark, enum plot_colour_component comp)
{

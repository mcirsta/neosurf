...
static bool html_process_inserted_base(html_content *htmlc, dom_node *node)
{
    ...
    exc = dom_element_get_attribute(node, corestring_dom_target, &atr_string);
    if ((exc == DOM_NO_ERR) && (atr_string != NULL)) {
         ...
         *  underscore
         */
        if (*dom_string_data(atr_string) != '_' || dom_string_caseless_lwc_isequal(atr_string, corestring_lwc__blank) ||
...
static bool html_process_inserted_link(html_content *c, dom_node *node)
{
    ...
    exc = dom_element_get_attribute(node, corestring_dom_hreflang, &atr_string);
    if ((exc == DOM_NO_ERR) && (atr_string != NULL)) {
    ...
    exc = dom_element_get_attribute(node, corestring_dom_media, &atr_string);
    if ((exc == DOM_NO_ERR) && (atr_string != NULL)) {
    ...
    exc = dom_element_get_attribute(node, corestring_dom_sizes, &atr_string);
    if ((exc == DOM_NO_ERR) && (atr_string != NULL)) {

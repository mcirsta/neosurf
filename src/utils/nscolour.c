    ...
    colour *bg_hover, colour *fg, colour *fg_subtle, colour *fg_faded, colour *fg_good, colour *fg_bad, colour *border)
{
    ...
    if (bg_hover != NULL) {
        *bg_hover = dark_mode ? half_lighten_colour(*bg) : half_darken_colour(*bg);
    }
    ...
    if (fg_good != NULL) {
        *fg_good = colour_engorge_component(*fg, !dark_mode, PLOT_COLOUR_COMPONENT_GREEN);
    }

    if (fg_bad != NULL) {
        *fg_bad = colour_engorge_component(*fg, !dark_mode, PLOT_COLOUR_COMPONENT_RED);
    }
...
nserror nscolour_update(void)
{
    ...
    res = nscolour__get("Canvas", "CanvasText", 16, 16, &nscolours[NSCOLOUR_WIN_EVEN_BG],
        &nscolours[NSCOLOUR_WIN_EVEN_BG_HOVER], &nscolours[NSCOLOUR_WIN_EVEN_FG],
        &nscolours[NSCOLOUR_WIN_EVEN_FG_SUBTLE], &nscolours[NSCOLOUR_WIN_EVEN_FG_FADED],
        &nscolours[NSCOLOUR_WIN_EVEN_FG_GOOD], &nscolours[NSCOLOUR_WIN_EVEN_FG_BAD],
        &nscolours[NSCOLOUR_WIN_EVEN_BORDER]);
    if (res != NSERROR_OK) {
        return res;
    }

    res = nscolour__get("Canvas", "CanvasText", 15, 16, &nscolours[NSCOLOUR_WIN_ODD_BG],
        &nscolours[NSCOLOUR_WIN_ODD_BG_HOVER], &nscolours[NSCOLOUR_WIN_ODD_FG], &nscolours[NSCOLOUR_WIN_ODD_FG_SUBTLE],
        &nscolours[NSCOLOUR_WIN_ODD_FG_FADED], &nscolours[NSCOLOUR_WIN_ODD_FG_GOOD],
        &nscolours[NSCOLOUR_WIN_ODD_FG_BAD], &nscolours[NSCOLOUR_WIN_ODD_BORDER]);
    if (res != NSERROR_OK) {
        return res;
    }

    res = nscolour__get("Highlight", "HighlightText", 16, 16, &nscolours[NSCOLOUR_SEL_BG], NULL,
        &nscolours[NSCOLOUR_SEL_FG], &nscolours[NSCOLOUR_SEL_FG_SUBTLE], NULL, NULL, NULL, NULL);
    if (res != NSERROR_OK) {
        return res;
    }
    ...
    res = nscolour__get("ButtonFace", "ButtonText", 16, 16, &nscolours[NSCOLOUR_BUTTON_BG], NULL,
        &nscolours[NSCOLOUR_BUTTON_FG], NULL, NULL, NULL, NULL, NULL);
    if (res != NSERROR_OK) {
        return res;
    }

    nscolours[NSCOLOUR_TEXT_INPUT_BG] = colour_to_bw_nearest(nscolours[NSCOLOUR_WIN_EVEN_BG]);
    nscolours[NSCOLOUR_TEXT_INPUT_FG] = colour_to_bw_nearest(nscolours[NSCOLOUR_WIN_EVEN_FG]);
    nscolours[NSCOLOUR_TEXT_INPUT_FG_SUBTLE] = blend_colour(
        nscolours[NSCOLOUR_TEXT_INPUT_BG], nscolours[NSCOLOUR_TEXT_INPUT_FG]);
...
nserror nscolour_get_stylesheet(const char **stylesheet_out)
{
    ...
    ret = snprintf(buffer, sizeof(buffer),
        ...
        "}\n",
        colour_rb_swap(nscolours[NSCOLOUR_WIN_ODD_BG]), colour_rb_swap(nscolours[NSCOLOUR_WIN_ODD_BG_HOVER]),
        colour_rb_swap(nscolours[NSCOLOUR_WIN_ODD_FG]), colour_rb_swap(nscolours[NSCOLOUR_WIN_ODD_FG_SUBTLE]),
        colour_rb_swap(nscolours[NSCOLOUR_WIN_ODD_FG_FADED]), colour_rb_swap(nscolours[NSCOLOUR_WIN_ODD_FG_GOOD]),
        colour_rb_swap(nscolours[NSCOLOUR_WIN_ODD_FG_BAD]), colour_rb_swap(nscolours[NSCOLOUR_WIN_EVEN_BG]),
        colour_rb_swap(nscolours[NSCOLOUR_WIN_EVEN_BG_HOVER]), colour_rb_swap(nscolours[NSCOLOUR_WIN_EVEN_FG]),
        colour_rb_swap(nscolours[NSCOLOUR_WIN_EVEN_FG_SUBTLE]), colour_rb_swap(nscolours[NSCOLOUR_WIN_EVEN_FG_FADED]),
        colour_rb_swap(nscolours[NSCOLOUR_WIN_EVEN_FG_GOOD]), colour_rb_swap(nscolours[NSCOLOUR_WIN_EVEN_FG_BAD]),

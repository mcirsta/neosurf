				...
				int *wday)
{
	...
	*day = (int)days + 1;
	...
	int wd = (int)((4 + (seconds >= 0 ? (seconds / 86400)
					  : ((seconds - 86399) / 86400))) %
		       7);
	if (wd < 0)
		wd += 7;
...
static const char *const timezones[NSC_TIME_ZONE__COUNT] = {
	[NSC_TIME_ZONE_IDLE] = "IDLE", [NSC_TIME_ZONE_NZST] = "NZST",
	[NSC_TIME_ZONE_NZT] = "NZT",   [NSC_TIME_ZONE_EAST] = "EAST",
	[NSC_TIME_ZONE_GST] = "GST",   [NSC_TIME_ZONE_JST] = "JST",
	[NSC_TIME_ZONE_CCT] = "CCT",   [NSC_TIME_ZONE_WAST] = "WAST",
	[NSC_TIME_ZONE_EET] = "EET",   [NSC_TIME_ZONE_CET] = "CET",
	[NSC_TIME_ZONE_FWT] = "FWT",   [NSC_TIME_ZONE_MET] = "MET",
	[NSC_TIME_ZONE_MEWT] = "MEWT", [NSC_TIME_ZONE_GMT] = "GMT",
	[NSC_TIME_ZONE_UTC] = "UTC",   [NSC_TIME_ZONE_WET] = "WET",
	[NSC_TIME_ZONE_WAT] = "WAT",   [NSC_TIME_ZONE_AST] = "AST",
	[NSC_TIME_ZONE_EST] = "EST",   [NSC_TIME_ZONE_CST] = "CST",
	[NSC_TIME_ZONE_MST] = "MST",   [NSC_TIME_ZONE_PST] = "PST",
	[NSC_TIME_ZONE_YST] = "YST",   [NSC_TIME_ZONE_AHST] = "AHST",
	[NSC_TIME_ZONE_CAT] = "CAT",   [NSC_TIME_ZONE_HST] = "HST",
	[NSC_TIME_ZONE_IDLW] = "IDLW", [NSC_TIME_ZONE_NZDT] = "NZDT",
	[NSC_TIME_ZONE_EADT] = "EADT", [NSC_TIME_ZONE_WADT] = "WADT",
	[NSC_TIME_ZONE_CEST] = "CEST", [NSC_TIME_ZONE_FST] = "FST",
	[NSC_TIME_ZONE_MEST] = "MEST", [NSC_TIME_ZONE_MESZ] = "MESZ",
	[NSC_TIME_ZONE_BST] = "BST",   [NSC_TIME_ZONE_ADT] = "ADT",
	[NSC_TIME_ZONE_EDT] = "EDT",   [NSC_TIME_ZONE_CDT] = "CDT",
	[NSC_TIME_ZONE_MDT] = "MDT",   [NSC_TIME_ZONE_PDT] = "PDT",
	[NSC_TIME_ZONE_YDT] = "YDT",   [NSC_TIME_ZONE_HDT] = "HDT",
	[NSC_TIME_ZONE_Y] = "Y",       [NSC_TIME_ZONE_X] = "X",
	[NSC_TIME_ZONE_W] = "W",       [NSC_TIME_ZONE_V] = "V",
	[NSC_TIME_ZONE_U] = "U",       [NSC_TIME_ZONE_T] = "T",
	[NSC_TIME_ZONE_S] = "S",       [NSC_TIME_ZONE_R] = "R",
	[NSC_TIME_ZONE_Q] = "Q",       [NSC_TIME_ZONE_P] = "P",
	[NSC_TIME_ZONE_O] = "O",       [NSC_TIME_ZONE_N] = "N",
	[NSC_TIME_ZONE_Z] = "Z",       [NSC_TIME_ZONE_A] = "A",
	[NSC_TIME_ZONE_B] = "B",       [NSC_TIME_ZONE_C] = "C",
	[NSC_TIME_ZONE_D] = "D",       [NSC_TIME_ZONE_E] = "E",
	[NSC_TIME_ZONE_F] = "F",       [NSC_TIME_ZONE_G] = "G",
	[NSC_TIME_ZONE_H] = "H",       [NSC_TIME_ZONE_I] = "I",
	[NSC_TIME_ZONE_K] = "K",       [NSC_TIME_ZONE_L] = "L",
	[NSC_TIME_ZONE_M] = "M"};
...
enum nsc_date_component_flags {
	...
	NSC_COMPONENT_FLAGS__HAVE_YYYYMMDD = NSC_COMPONENT_FLAGS_HAVE_YEARS |
					     NSC_COMPONENT_FLAGS_HAVE_MONTHS |
					     NSC_COMPONENT_FLAGS_HAVE_DAYS,
	NSC_COMPONENT_FLAGS__HAVE_HHMMSS = NSC_COMPONENT_FLAGS_HAVE_HOURS |
					   NSC_COMPONENT_FLAGS_HAVE_MINS |
					   NSC_COMPONENT_FLAGS_HAVE_SECS,
	NSC_COMPONENT_FLAGS__HAVE_ALL = NSC_COMPONENT_FLAGS_HAVE_YEARS |
					NSC_COMPONENT_FLAGS_HAVE_MONTHS |
					NSC_COMPONENT_FLAGS_HAVE_DAYS |
 ...
 */
static inline bool time__parse_weekday(const char *str,
				       size_t len,
 ...
 */
static inline bool time__parse_month(const char *str,
				     size_t len,
				     enum nsc_date_component_flags *flags,
 ...
 */
static inline bool time__parse_timezone(const char *str,
					size_t len,
					enum nsc_date_component_flags *flags,
					struct nsc_date_parse_ctx *ctx)
{
	...
	for (uint32_t i = 0; i < NSC_TIME_ZONE__COUNT; i++) {
		if (ascii_strings_count_equal_caseless(timezones[i], str) ==
		    len) {
 ...
 */
static inline bool time__parse_hh_mm_ss(const char *str,
					size_t *len,
					enum nsc_date_component_flags *flags,
					struct nsc_date_parse_ctx *ctx)
{
 ...
 */
static inline bool time__parse_number(const char *str,
				      size_t len,
				      enum nsc_date_component_flags *flags,
				      struct nsc_date_parse_ctx *ctx)
{
	...
	case 4:
		if (!flags_chk(*flags, NSC_COMPONENT_FLAGS_HAVE_TIMEZONE)) {
			if (ascii_is_sign(ctx->prev) && value <= 1400) {
				ctx->timezone_offset_mins = value / 100 * 60 +
							    value % 100;
				if (ctx->prev == '+') {
				   ...
				   time_t *time)
{
	...
	int year = (ctx->month < NSC_TIME_MONTH_FEB) ? ctx->years - 1
						     : ctx->years;
	...
	*time = (((((time_t)(total_days)) * 24) + ctx->hours) * 60 + mins) *
			60 +
		ctx->secs;
	return NSERROR_OK;
}
...
static nserror time__get_date(const char *str, time_t *time)
{
	...
	struct nsc_date_parse_ctx ctx = {.prev = '\0',
					 .secs = 0,
					 .mins = 0,
					 .hours = 0,
					 .day = 0,
	...
	if (ctx.secs > 60 || ctx.mins > 59 || ctx.hours > 23 || ctx.day > 31 ||
	    ctx.month > 11) {
		return NSERROR_INVALID;
	}

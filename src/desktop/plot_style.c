...
plot_style_t const *const plot_style_content_edge = &plot_style_content_edge_static;
...
plot_style_t const *const plot_style_padding_edge = &plot_style_padding_edge_static;
...
plot_style_t const *const plot_style_margin_edge = &plot_style_margin_edge_static;
...
plot_style_t const *const plot_style_broken_object = &plot_style_broken_object_static;
...
plot_font_style_t const *const plot_fstyle_broken_object = &plot_fstyle_broken_object_static;

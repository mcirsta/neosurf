...
void browser_mouse_state_dump(browser_mouse_state mouse)
{
    NSLOG(netsurf, INFO, "mouse state: %s %s %s %s %s %s %s %s %s %s %s %s %s %s",
        ...
        mouse & BROWSER_MOUSE_DRAG_1 ? "D1" : "  ", mouse & BROWSER_MOUSE_DRAG_2 ? "D2" : "  ",
        mouse & BROWSER_MOUSE_DRAG_ON ? "DO" : "  ", mouse & BROWSER_MOUSE_HOLDING_1 ? "H1" : "  ",
        mouse & BROWSER_MOUSE_HOLDING_2 ? "H2" : "  ", mouse & BROWSER_MOUSE_MOD_1 ? "M1" : "  ",
        mouse & BROWSER_MOUSE_MOD_2 ? "M2" : "  ", mouse & BROWSER_MOUSE_MOD_3 ? "M3" : "  ");
}
